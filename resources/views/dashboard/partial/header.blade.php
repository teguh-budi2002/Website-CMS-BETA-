<nav class="py-3 w-full fixed top-0 z-40 bg-gray-700">
    <div class="flex justify-end mx-5">
        <button type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation"
            aria-controls="drawer-navigation"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
...
<div id="drawer-navigation" class="fixed z-50 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800" tabindex="-1"
            ...
            <li>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li class="flex items-center hover:bg-gray-100">
                        ...
                        <a href="{{ URL('/gae-post/buat/postingan') }}"
                            class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group">Article
                            Post</a>
                    </li>
                    <li class="flex items-center hover:bg-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <a href="{{ URL('/gae-kategori/kategori') }}"
                            class="w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group">Category
                            Post</a>
                    </li>
                    <li>
                        <a href="#"
